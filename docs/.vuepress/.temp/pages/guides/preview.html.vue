...
支持流程过程中的各类文档类型，如txt文本，图片、视频、音频、PDF、Word、Excel、PPT等。</p>
<h3 id="pdf归档" tabindex="-1"><a class="header-anchor" href="#pdf归档"><span>PDF归档</span></a></h3>
<ul>
<li>
<p>内容打包
PDF归档功能允许用户将流程的所有信息打包成一个PDF文件，方便用户保存和分享。用户可以通过点击流程的“归档”按钮，打开PDF归档窗口，选择需要归档的流程，然后点击“生成PDF”按钮，即可生成PDF文件。</p>
</li>
<li>
<p>压缩
所有文件可以压缩为一个zip文件，提供日后下载。</p>
</li>
</ul>
</div></template>
