...
<p>流程框架在各个处理环节，一般情况下是无法对最初的流程设计进行更改的。<br>
想象一下场景：
任务分配流程：
最初设计流程时，部门涉及到有 3 层结构，流程的方向是从高级部门到低级部门，流程需要在第二级部门时，把权限分配给二级部门的审批人</p>
<ul>
<li>资金拨付审批
上级部门将资金拨付给下级部门后，希望由 2 级部门将资金分配给 3 级部门，例如三级部门有 10 个，总的资金是 100 万元，现在需要将 100 万元，
这时可以将分配权交给下级部门，由下级部门自主决定，这种场景下，下级部门的分配情况可能如下：</li>
</ul>
<table>
<thead>
<tr>
